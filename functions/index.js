 ...
 const ACHTaskHandler = require(functions['ACH_task'].path);
 const CreditCardTaskHandler = require(functions['CreditCard_task'].path);
...
exports.handler = async (context, event, callback) => {
  ...
  switch (CurrentTask) {
    ...
    case 'Address':
      ...
      case 'ACH':
      console.log('ACH');
      await ACHTaskHandler.ACH_task(context, event, callback,responseBuilder.RB);
      break;

      case 'CreditCard':
      console.log('CreditCard');
      await CreditCardTaskHandler.CreditCard_task(context, event, callback,responseBuilder.RB);
      break;
